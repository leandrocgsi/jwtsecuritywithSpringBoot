...
import com.jwt.converter.serialization.YamlJacksonToHttpMassageConverter;
...
public class WebDataConfig implements WebMvcConfigurer{
	...
	public void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
		converters.add(new YamlJacksonToHttpMassageConverter());
	}
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		/**
		 * data convert
		//via extension http://localhost:8080/person/1.xml
